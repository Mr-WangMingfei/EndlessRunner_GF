...
/// <summary>
/// This defines a "piece" of the track. This is attached to the prefab and contains data such as what obstacles can spawn on it.这定义了轨道的“片段”。 它附着在预制件上，并包含诸如可以在其上产生什么障碍的数据。
/// It also defines places on the track where obstacles can spawn. The prefab is placed into a ThemeData list. 它还定义了轨道上可能产生障碍物的位置。 预制件放置在ThemeData列表中。
/// </summary>
