...
public class PatrollingObstacle : Obstacle
{
	...
	void Start()
	{
		...
		m_OriginalPosition = transform.localPosition + transform.right *1;
        ...
        m_MaxSpeed = (1f * k_LaneOffsetToFullWidth * 2) / actualTime;
	...
	void Update()
	{
        ...
        transform.localPosition = m_OriginalPosition - transform.right * Mathf.PingPong(m_CurrentPos, 1 * k_LaneOffsetToFullWidth);
	}
}
